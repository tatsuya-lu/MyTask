<template>
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div v-for="team in teamStore.teams" :key="team.id" class="border rounded-lg p-4">
                ...
                <button v-if="team.owner_id === authStore.user?.id" @click="showAddMemberModal(team)"
        ...
        <!-- メンバー追加モーダル -->
        <AddMemberModal v-if="showAddMemberModal" :team="selectedTeam" @close="closeAddMemberModal"
